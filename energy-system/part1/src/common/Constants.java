...
public final class Constants {
    ...
    public static final String NO_CONSUMERS = "CONSUMERS DO NOT EXIST";
    public static final String NO_DISTRIBUTORS = "DISTRIBUTORS DO NOT EXIST";
    public static final String NO_UPDATES = "UPDATES DO NOT EXIST";
    public static final double PROFIT_PERCENTAGE = 0.2;
    public static final double DEBT = 1.2;
    public static final String PREPARE = "prepare";
    public static final String START_NUMBEROFTURNS = "numberofturns";

...
public final class ActionInputData {
    ...
    /**
     * prelucreaza filtrele date in action
     * @return
     */
    ...
    /**
     * intoarce lista de awards din filters
     *
     * @return
     */
    public ArrayList<String> getFilterAwards() {
        final int a = 3;
        ArrayList<String> awards = new ArrayList<>(filters.get(a));
        return awards;
    }
